                    ...
                    <div class="widget-content">
                        <form id="myform" method="post" class="form-horizontal">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input name="ebike_name" value="{{$ebike[0]->ebike_name}}" type="text" class="span11"/>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input name="ebike_remark" value="{{$ebike[0]->ebike_remark}}" type="text" class="span11"/>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <select name="brand_id">
                                        <option value="{{$ebike[0]->brand_id}}">{{$ebike[0]->brand_name}}</option>
